...
reg_all=reg_r1[:]+reg_r1a[:]+reg_r2[:]+reg_r2a[:]

# initial T

circ_init=qk.QuantumCircuit(reg_r1, reg_r1a, reg_r2, reg_r2a)
# QPE
circ_init.append(HGate().control(1,None,'0'),[reg_r1a[0]]+[reg_r2[0]])
circ_init.append(XGate().control(1,None,'1'),[reg_r1a[0]]+[reg_r2a[0]])
circ_init.barrier()
circ_init.append(ZGate(),[reg_r2[0]])
circ_init.append(XGate(),[reg_r2[0]])
circ_init.append(ZGate(),[reg_r2[0]])
circ_init.append(XGate(),[reg_r2[0]])
circ_init.append(XGate().control(1,None,'0'),reg_r2[:]+reg_r2a[:])
circ_init.append(ZGate().control(1,None,'0'),reg_r2[:]+reg_r2a[:])
circ_init.append(XGate().control(1,None,'0'),reg_r2[:]+reg_r2a[:])
circ_init.barrier()
circ_init.append(XGate().control(1,None,'1'),[reg_r1a[0]]+[reg_r2a[0]])
circ_init.append(HGate().control(1,None,'0'),[reg_r1a[0]]+[reg_r2[0]])
...
circ_init.barrier()
circ_init.append(SwapGate(),reg_r1[:]+reg_r2[:])
circ_init.append(SwapGate(),reg_r1a[:]+reg_r2a[:])
circ_init.barrier()
circ_init.append(SGate(),[reg_r1[0]])
circ_init.append(XGate(),[reg_r1[0]])
circ_init.append(SGate(),[reg_r1[0]])
circ_init.append(XGate(),[reg_r1[0]])
