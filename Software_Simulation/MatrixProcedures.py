...
class MatrixSystem:
    ...
    def FileInitMatlab(self, A_file: str = "./matrix_data/matrix_2_1.dat", b_file: str = "./matrix_data/rvec_2_1.dat"):
        """Load A₀ and b₀ from text files."""
        self.A0_indices.clear()
        self.A0_elements.clear()
        self.b0.clear()
    ...
    def CompareClassical(self, sol, args):
        """
        ...
        with open("./benchmarking/res_"+str(args.dimension)+"_"+str(args.testind)+"_"+str(args.phase)+".dat", "a") as f:
            with redirect_stdout(f):
                print("%20.10f"%(np.mean(rel_errors)))
