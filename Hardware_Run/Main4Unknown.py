...
#-----------------------------------------------
#  implements the 4-unknown hardware test
...
qasm2.dump(target_circuit, f"./qasms/Trial1_short/whole.qasm")
...
#while current_index < 5:
    ...
    b0 = [0.7887, 0.7887, -0.9434, 1.3660]  # *Note: equal superposition of system matrix's eigenvectors
    ...
    qasm2.dump(isa_qc, f"./qasms/Trial1_short/step_{current_index}.qasm")
